...
if __name__ == '__main__':
    # 1 sampling
    obj_path = 'data/model.obj'
    mesh_list = trimesh.load(obj_path, force='mesh')
    ...
    view_path = 'data/rendering/rendering_metadata.txt'
    ...
    for index, param in enumerate(cam_params):
        ...
        cv2.imwrite(img_path.replace('rendering/',''), img)
        train_data.dump(img_path.replace('.png','.dat'))
